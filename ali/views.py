...
from afandi.forms import CartAddProductForm
from afandi.keranjang import Cart
from django.shortcuts import render, get_object_or_404
from .models import Produk, Kategori, Kontak, Profil, Slide, Statis, ChatID
from afandi.models import Transaksi, DetailTransaksi
...
def beranda(request):
    ...
    trending = Produk.objects.filter(aktif=True).order_by('-dibeli')
